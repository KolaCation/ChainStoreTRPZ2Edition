    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        public MainViewModel(IAuthenticator authenticator)
        {
            ...
            NavigateToProfile = new RelayCommand(() =>
            {
                ...
                {
                    HandleNavigation(new NavigationMessage(nameof(ProfileViewModel), _authenticator.GetCurrentUser().ClientId));
                }
                else
                {
        ...
        /// <param name="storeDetailsViewModel">storeDetailsViewModel</param>
        /// <param name="purchaseViewModel">purchaseViewModel</param>
        /// <param name="bookViewModel">bookViewModel</param>
        /// <param name="profileViewModel">profileViewModel</param>
        /// <param name="categoriesViewModel">categoriesViewModel</param>
